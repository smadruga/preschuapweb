                ...
                <div class="ms-1 me-1">
                    <div class="row">
                        ...
                        <div class="col container border border-dark pt-2 border-start-0">
                            ...
                            <div class="row">
                                <div class="col"><b>Paciente: <?= $v['nome'] ?></b></div>
                            </div>
                            <div class="row">
                                <div class="col"><b>Telefone: <?= $v['telefone'] ?></b></div>
                            </div>                            
                            <div class="row">
                                <div class="col-5"><b>Nascimento:</b> <?= $v['dt_nascimento'] ?></div>
                                <div class="col"><b>Idade:</b> <?= $v['idade'] ?></div>
