...
<html>
    <head>
        ...
        <link href="<?= base_url('/assets/img/oncorede/oncorede-128.png') ?>" sizes="180x180" rel="apple-touch-icon">
        <link href="<?= base_url('/assets/img/oncorede/oncorede-32.png') ?>" sizes="32x32" type="image/png" rel="icon">
        <link href="<?= base_url('/assets/img/oncorede/oncorede-16.png') ?>" sizes="16x16" type="image/png" rel="icon">
