...
class Prescricao extends BaseController
{
    ...
    */
    ...
    {
        return view('admin/prescricao/form_pesquisa_paciente');
    }
    ...
    */
    public function get_paciente($paciente = false)
    {
        ...
        if (!$v['paciente']) {
            ...
            return redirect()->to('prescricao/find_paciente');
        }
        #se o resultado for um vai direto para a página de importação
        elseif ($v['paciente']['count'] == 1)
            return redirect()->to('prescricao/show_paciente/'.$v['paciente']['array'][0]['codigo']);
        #se o resultado for mais que um vai para uma lista de opções
            ...
            return redirect()->to('prescricao/list_paciente');
        }
            #return view('admin/prescricao/list_paciente', $v);
    ...
    */
    public function show_paciente($data)
    {
        ...
        return view('admin/prescricao/page_paciente', $v);
